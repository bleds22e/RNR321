...
# mutate 
# creates a new column by applying a function to another column
surveys %>% 
  filter(!is.na(weight)) %>% 
...
# split, apply, combine
# split up data by some variable
# apply function or calculation
# combine the results of all groups
