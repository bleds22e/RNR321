...
6.  Divide the object `birds` by 5. Name the result `fewer_birds`.
...
16. Write a line of code that determines how many recorded cactus pads had no damage to them. (_Hint: looking back at the code you wrote to complete Questions 14 and 15 will be helpful!_)
...
17. Write a line of code that pulls out all of the elements in the `pad_length` vector which are greater than 5.
