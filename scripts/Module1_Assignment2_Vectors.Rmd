...
14. Using a function, write a line of code for which the output is the number of elements in the `damage` vector.

```{r}

```

15. Write a line of code that pulls out all of the elements of the `damage` vector which have no damage on the pad.

```{r}

```

16. Combining your answers for Questions 13 and 14, write a line of code that determines how many recorded cactus pads had no damage to them.
