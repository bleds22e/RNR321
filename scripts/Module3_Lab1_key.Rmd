...
```{r}
# your filepath will not have "../data_raw/" in it
...
surveys_df <- data.frame(time_1 = rep("1", 20),
                         time_2 = rep("2", 20),
                         time_3 = rep("3", 20),
                         time_4 = rep("4", 20),
                         time_5 = rep("5", 20))
...
surveys_list <- list(time = surveys_df)
...
tortUMF <- unmarkedFrameOccu(tort_occ, obsCovs = surveys_list)
```
...
models <- fitList(pdot_psidot  = pdot_psidot,  # name in output = object
                  ptime_psidot = ptime_psidot) # name in output = object
