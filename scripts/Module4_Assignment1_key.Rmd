...
```{r}
insects <- read.csv("../data_raw/insects.csv")
```
...
7.  Write a line of code to calculate the number of individuals in the insect community. Use this to create the object `total_comm1`.
