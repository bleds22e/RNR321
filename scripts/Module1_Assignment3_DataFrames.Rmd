...
cactus <- read.csv("AllCactusData.csv")
```
...
17. Interpret the results from Q15 and Q16, comparing and contrasting the two species. What do the results tell us about the depth of cactus pads and the distribution of the data?
