...
5.  Write a line of code using *sub-setting via indexing* to return the element "Spud" from the vector `pet_names`.

```{r}

```

6.  Now, write a line of code using *conditional sub-setting* that returns the element "Spud".
