...
Based on what I've taught you in R thus far, the easiest way to do
    our calculations will be to have three different data frames, one
    for each stratum.
...
That said, if you're feeling super ambitious and want to *try* to
    use the `tidyverse` and a lot of `group_by()`, `mutate()`, and
    `summarise()` functions, be my guest! To be clear, though, that is
