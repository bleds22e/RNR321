...
```{r}
cactus <- read.csv("CactusPads.csv")
```
...
12. Write a line of code that saves the 42nd value in the `pad_width` column as an object called `answer`. Remember to retype `answer` on a new line in the code chunk to print the output.
