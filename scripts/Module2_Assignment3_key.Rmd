...
4.  Start by calculating the numerators (N~i~ \* s~i~ / square root of c~i~) for each stratum. Remember to use objects you've created rather than typing out specific numbers into the equation.
...
10. To do this, calculate the following:
    ...
    a.  variance of the estimate of the mean per stratum (var_y\_bar). Remember that we need to use the finite population correction factor and to use only objects already created, not plain numbers! (2 points)
