...
7.  If we did not have the pilot study telling us about the variation of the populations in each strata, we could have allocated very differently:
    ...
    *Answer:* without taking standard deviation into account, we would have had far less precise estimates because we would have allocated more samples to strata with low variability; cost is also factored in
...
10. To do this, calculate the following:
    ...
    # also need to use var_X rather than sd_X^2 because the sd_X values are made up
