...
3.  Write a line of code that selects values less than 66 from the `counts` vector. The `NA` value will be included in the resulting vector, which is fine.
...
```{r}
pet_names <- c("Mystery", "Hazel", "Spud", "Sandy")
pet_names
```
