...
# code for installing a package from the internet
...
```{r}
# you will not normally need to do this
penguins <- penguins
```
...
Note that this pattern (rows, columns) is the opposite of spreadsheets typically describe locations.
...
If you're done, see if you can help a neighbor!
