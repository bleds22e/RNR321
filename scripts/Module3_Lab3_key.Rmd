...
```{r}
beads$transect_length_m <- beads$TransectLength_ft / 3.281
...
transect_length <- data.frame(group_id = 1:10,
                              length_m = mean(beads$transect_length_m))
```
...
# D-hat * area/ha
density_estimate * area/ha
```

Maddie and I put out 50 green beads, so this is...kind of accurate?
