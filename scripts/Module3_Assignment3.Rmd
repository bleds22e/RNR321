...
4.  Use unmarked function `formatDistData` to count the number of saguaros in each distance bin for each transect. Save this as an object called `sag_data`. Ignore the *warning* message (but if you get an *error* message, that is different!).
