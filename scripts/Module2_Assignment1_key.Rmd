...
6.  Create the object `N`, which is the number of units in your
    *sampling frame*. No functions needed; type the number and assign it
    ...
    Remember to print out the objects you create by typing the name of the object in the line below where you create it. This helps us out while grading quite a bit!
