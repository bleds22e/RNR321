...
(d) In the Files tab in the bottom right-hand corner, check the box next to the .csv file that you just uploaded, then click the "Rename" button (near "Upload").
(e) Rename your .csv file to "rock_data.csv"
...
(c) Because you each have different values for your number of rocks, the
...
6.  Create the object `N`, which is the number of units in your
    *sampling frame*. No functions needed; type the number and assign it to `N`.
...
-   What is your estimate of density of dark rocks (average \# dark
    rocks per little square)? How much variation is in the number of dark rocks per little square? How uncertain
    are you of your estimate of the density?
