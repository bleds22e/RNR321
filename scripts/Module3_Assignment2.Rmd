...
1A:  Detection is *higher* than the demo
1B:  Detection is *lower* than the demo

**Scenario 2: Detection Probability Changes with Behavior**

2A:  Animals are "trap shy"
2B:  Animals are "trap happy"
...
13. Compare the bias and precision of our total abundance estimates for the *demonstration* (between Questions 7 and 8), trap happy, and trap shy populations. 
