...
16. Compare the ranges of the 95% CI for the PP and the PB data. Which estimate of the mean seems to be more accurate, based on size of the confidence intervals? Why do you think that is (AKA what value is driving that difference)? (2 points)

*Answer:* PB seems more accurate. This is because the SE is lower, leading to smaller CIs. (they don't need to say this for full credit, but this is actually being driven by the differences in standard deviation since the sample sizes are the same)
