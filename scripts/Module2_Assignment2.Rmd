...
10. What happens when we creat 90% CI for the data? Calculate 90% CI and
    compare to the 95% CI. Which one is wider? Why? (2 points)
...
11. Create an object called `PB_mean` that contains the sample mean (AKA
    the mean number of dark stones per sample unit). Follow the code
    example above.
