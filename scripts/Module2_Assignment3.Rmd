...
NOTE: Open up your script from Module 2, Assignment 2---it's about to come in handy! I would also recommend opening up the lecture slides (download them to see all equations).
...
10. To do this, calculate the following:
    ...
    b.  variance of the estimate of the total (var_tau_hat). You might need to go fishing for this equation in one of the earlier powerpoints. (1 point)
...
Next, we will calculate the overall total (abundance) and the variance of the estimate of the total.
...
Okay, that was a lot of calculating! Let's summarize and make sure we know what just happened. We were ultimately able to calculate estimates the parameters we were interested in: the population mean and the population total along with the amount of uncertainty in both of those estimates.
...
12. Based on our calculations above, answer the following questions with the **name of the R object** and its **corresponding value** for each calculation. (2 points)
    ...
    c.  measure of uncertainty in the \# of grasshoppers per sample unit:
