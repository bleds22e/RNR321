...
Calculating population metrics and running occupancy models for _Amaranth palmerii_ ("amar palm").
...
We will keep this simple. Calculate species richness for the summer plant survey in 2021. 
Using the `plant_data` data frame, filter the data appropriately and then use the `unique()` function.
